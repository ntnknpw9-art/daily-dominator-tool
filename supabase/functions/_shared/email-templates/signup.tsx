...
export const SignupEmail = ({
  ...
  <Html lang="he" dir="rtl">
    <Head />
    <Preview>קוד האימות שלך ל-{siteName}</Preview>
    <Body style={main}>
      <Container style={container}>
        <Heading style={brand}>Daily Dominator</Heading>
        <Heading style={h1}>אימות כתובת המייל שלך</Heading>
        <Text style={text}>
          ברוך הבא ל-{siteName}. הזן את הקוד הבא באפליקציה כדי לאמת את {recipient}:
        </Text>
        {token && (
        ...
        <Text style={text}>או לחץ על הכפתור כדי לאמת ישירות:</Text>
        <Button style={button} href={confirmationUrl}>
          אמת את המייל שלי
        </Button>
        <Text style={footer}>
          אם לא נרשמת ל-{siteName}, ניתן להתעלם מהמייל. הקוד תקף ל-15 דקות.
        </Text>
      </Container>
    </Body>
  </Html>
