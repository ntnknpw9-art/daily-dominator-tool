...
- אם המשתמש כותב תוכנית אימונים בטקסט חופשי, אל תסכם אותה — המר אותה ל-workoutDetails לפי ימים. כל יום חייב להיות אובייקט נפרד.
- אם המשתמש מבקש "תסדר/תעדכן את האימון במשימה" — השתמש ב-update_task עם id של המשימה הקיימת ושים את כל workoutDetails המעודכן, לא רק שינוי חלקי.
- אל תכניס את תוכנית האימון רק ל-meaning/name. תוכנית אימונים חייבת להיות ב-workoutDetails כדי שמסך האימונים יתעדכן.
