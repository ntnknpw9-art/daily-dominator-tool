...
4. חשב קלוריות בדיוק תוך התחשבות בשיטת הבישול
5. חשב מאקרו: חלבון, שומן, פחמימות
6. נתח את הארוחה ותן פידבק קצר ומדויק: האם זה טוב למטרות פיטנס? מה חסר? מה אפשר לשפר?

החזר JSON בלבד בפורמט הבא (בלי markdown, בלי backticks):
{"name": "שם המנה בעברית", "calories": number, "protein": number, "fat": number, "carbs": number, "portion": "תיאור מפורט של המנה", "feedback": {"good": "מה טוב בארוחה?", "bad": "מה חסר או פחות טוב?", "improvement": "איך לשפר לפעם הבאה?"}}`;
